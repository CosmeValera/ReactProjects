var VueRemote = function(exports) {
  "use strict";
  /**
  * @vue/shared v3.5.29
...
- For vite: pass it via @vitejs/plugin-vue options. See https://github.com/vitejs/vite-plugin-vue/tree/main/packages/plugin-vue#example-for-passing-options-to-vuecompiler-sfc`;
  ...
  **/
  ...
  function _sfc_render(_ctx, _cache) {
    return openBlock(), createElementBlock("p", null, "Hello world, I'm a Vue project");
  }
  const HelloWorld = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
  function mount(el) {
